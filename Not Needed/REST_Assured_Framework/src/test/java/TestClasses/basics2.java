...
//	@Test
	public void createPlaceAPI() {
		...
		given().
				...
				queryParam("key", "AIzaSyDIQgAh0B4p0SdyYkyW8tlG-y0yJMfss5Y").body(payLoad.createPlaceData()).when()
	...
	@Test
	public void testResReqpost1() {
		RestAssured.baseURI = "https://reqres.in";

		Response res = given().body(payLoad.getdata1()).
